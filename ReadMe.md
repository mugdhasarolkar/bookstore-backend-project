...
Development Note: The backend is fully operational and has been rigorously verified using Postman. While the frontend was initialized using the Vite + React framework, the current focus of this repository is on the backend API implementation.
...
RESTful API: Developed using Express.js to handle client-server communication.
